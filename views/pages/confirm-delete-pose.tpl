...
{block name="body"}
    <div class="container pt-5 pb-5">
        <div class="row">
            ...
            {/if}
            <p>{$user_data['user_name']}, are you sure you want to delete this pose?</p>
            ...
            <form method="post">
                ...
                <button type="submit" class="danger" name="deletePose" value="1">Delete Pose <i
